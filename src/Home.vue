<template>
  ...
  >
    ...
    <div class="lg:w-1/2">
      ...
      <div class="mt-6 lg:flex lg:items-center">
  ...
  <section class="bg-[#343D33] lg:mt-12">
    ...
    <div class="container flex flex-col px-6 py-16 mx-auto lg:mt-12">
      ...
      >
        ...
        <img
            class="object-cover w-full lg:w-1/2 lg:mx-6 h-72 lg:h-96 border-2 border-white rounded-lg"
            src="/img/image1.webp"
            alt=""
        />

        <div
            class="mt-8 lg:w-1/2 lg:mx-6 lg:mt-0 flex flex-col items-center md:items-start lg:items-start xl:items-start">
          ...
          <p class="mt-4 text-gray-200 text-center md:text-left lg:text-left xl:text-left">
      ...
      <img
          class="order-1 object-cover lg:order-2 w-ful h-72 lg:h-96 lg:mt-12 border-2 border-white rounded-lg"
          src="/img/image2.webp"
          alt="home2"
          rel="preload"
      />
